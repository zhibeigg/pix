...
<p align="center">
  ...
  <img alt="version" src="https://img.shields.io/badge/version-1.4.0-6f42c1.svg">
...
- **Web 工作台**
  ...
  - 主页展示中文 prompt 素材示例，悬浮即可查看源图、Grid、预览三图详情。
...
- 首页展示中文 prompt 示例，鼠标悬浮或键盘聚焦物品格可展开源图 / Grid / 预览详情

...
<p align="center">
  ...
  <img alt="version" src="https://img.shields.io/badge/version-1.7.0-6f42c1.svg">
...
- **Web 工作台**
  ...
  - 主页采用低饱和像素工坊视觉，展示中文 prompt 全流程素材示例；76 套题材范例使用首屏同款素材格，悬浮/键盘聚焦即可查看物品精灵表、UI 展示图、Prompt 和文件名。

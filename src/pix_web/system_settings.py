...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("pix.asset.prompt_template", "素材 Prompt 模板", "素材默认值", "textarea", "", "可用占位符：{width}/{height}/{size_label}/{asset_kind_label}/{subject_kind_label}/{canvas_shape}/{name}；用户通常只填写主体内容。"),

...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("pix.api.gemini_api_key", "Packy Gemini 生图 API Key", "模型与 API", "secret", "", "用于 gemini-3.1-flash-image-preview 等 Gemini 生图模型。", secret=True, env_var="PACKY_GEMINI_API_KEY"),
    ...
    SettingDefinition("pix.image_gen.model", "生图模型", "模型与 API", "string", "", "当前支持 gpt-image-2、gemini-3.1-flash-image-preview。"),

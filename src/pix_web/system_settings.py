...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("web.turnstile_enabled", "启用 Cloudflare 人机校验", "邮件验证码", "boolean", "", "开启后注册发送验证码前必须通过 Turnstile。需先填写 site key 与 secret key。", env_var="PIX_WEB_TURNSTILE_ENABLED"),
    ...
    SettingDefinition("pix.api.base_url", "旧 Packy API Base URL", "模型与 API", "string", "", "兼容 PACKY_BASE_URL；新部署优先使用 config.toml 的 [[image_providers]]。", env_var="PACKY_BASE_URL"),
    SettingDefinition("pix.api.image_api_key", "旧 Packy 生图 API Key", "模型与 API", "secret", "", "兼容 PACKY_API_KEY。Crazyrouter 等新 Provider 建议使用环境变量或 config.toml 配置。", secret=True, env_var="PACKY_API_KEY"),
    SettingDefinition("pix.api.vl_api_key", "VL API Key", "模型与 API", "secret", "", "可覆盖 PACKY_VL_API_KEY；VL/chat 暂沿用 OpenAI-compatible chat endpoint。生产建议使用环境变量。", secret=True, env_var="PACKY_VL_API_KEY"),
    SettingDefinition("pix.api.gemini_api_key", "旧 Gemini 生图 API Key", "模型与 API", "secret", "", "兼容 gemini-3.1-flash-image-preview 等旧配置。", secret=True, env_var="PACKY_GEMINI_API_KEY"),

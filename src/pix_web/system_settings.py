...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("web.public_base_url", "站点公开 URL", "支付与站点", "string", "", "用于支付回调与返回地址。", env_var="PIX_WEB_PUBLIC_BASE_URL"),
    ...
    SettingDefinition("pix.image_gen.green_screen_color", "绿幕颜色", "模型与 API", "string", ""),
    SettingDefinition("pix.image_gen.green_screen_tolerance", "绿幕容差", "模型与 API", "number", ""),
    ...
    SettingDefinition("pix.asset.grid_review", "默认 Grid Review", "素材默认值", "boolean", ""),
    ...
    SettingDefinition("pix.asset.ai_grid_draft_max_axis", "draft 最大轴", "素材默认值", "number", ""),
    SettingDefinition("pix.asset.ai_grid_draft_preview_scale", "draft 预览放大倍数", "素材默认值", "number", ""),

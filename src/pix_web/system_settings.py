...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("pix.asset.prompt_template", "素材 Prompt 模板", "素材默认值", "textarea", "", "可用占位符：{size_label}/{asset_kind_label}/{subject_kind_label}/{canvas_shape}/{name}；用户通常只填写主体内容。"),
    ...
    SettingDefinition("pix.sprite.key_mode", "动画抠色模式", "动画精灵表", "select", "hard=纯阈值硬抠；soft=半透明软抠色并去污染。", options=("hard", "soft")),

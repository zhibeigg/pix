 ...
 *
 * 11 张示例都来自实跑过的 sprite_sheet / video_bridge 任务产物，已复制到
...
export const homepageSpriteExamples: HomepageSpriteExample[] = [
  {
    id: '00_xianxia_spirit_boar',
    number: '00',
    category: 'creature',
    generationMode: 'video_bridge_loop',
    theme: '仙侠灵纹野猪',
    themeEn: 'Jade-marked spirit boar',
    subject: '灵纹野猪幼兽',
    subjectEn: 'Jade-marked boar monster cub',
    prompt: '24x24 像素风仙侠野猪幼兽，侧视，矮壮身躯，深色硬鬃毛，短獠牙，额头与身侧有发光的翡翠色灵纹，带小妖山兽气质，居中纯洋红底。',
    promptEn: 'A tiny 24x24 true pixel-art xianxia boar monster cub, side view, squat sturdy body, dark bristly fur, short tusks, small glowing jade spirit markings on forehead and flank, a little demonic mountain-beast charm, readable silhouette, centered on a pure magenta key-color background.',
    rowPrompts: ['待机呼吸无缝循环：野猪幼兽轻微起伏呼吸，耳朵抽动一次，尾巴小幅甩动，翡翠灵纹柔和脉动，四蹄保持扎实站定并回到起始姿态'],
    rowPromptsEn: ['Seamless idle breathing loop: the boar monster gently breathes in and out, ears twitch once, tail flicks slightly, jade spirit markings pulse softly, hooves stay planted, then returns to the starting idle pose'],
    src: '/homepage-examples/sprites/00_xianxia_spirit_boar.png',
    sheetWidth: 2048,
    sheetHeight: 128,
    frameWidth: 128,
    frameHeight: 128,

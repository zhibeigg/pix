...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium leading-[1.3] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:bg-border disabled:text-[hsl(var(--pix-muted))] disabled:opacity-100 [&_svg]:pointer-events-none [&_svg]:size-4',
  {
    variants: {
      variant: {

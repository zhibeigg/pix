...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium leading-[1.3] transition-[background-color,border-color,box-shadow,color,opacity,transform] duration-[var(--motion-fast)] ease-[var(--ease-out-quart)] will-change-transform hover:shadow-[0_8px_22px_-18px_rgba(15,15,15,.55)] active:shadow-[0_2px_8px_-8px_rgba(15,15,15,.5)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:bg-border disabled:text-[hsl(var(--pix-muted))] disabled:opacity-100 disabled:shadow-none disabled:will-change-auto [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:transition-transform [&_svg]:duration-[var(--motion-fast)] [&_svg]:ease-[var(--ease-out-quart)] hover:[&_svg]:translate-x-px',
  {
    variants: {
      variant: {

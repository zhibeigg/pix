...
const badgeVariants = cva('inline-flex shrink-0 items-center whitespace-nowrap rounded-full border px-2.5 py-1 text-[13px] font-semibold leading-[1.4] transition-colors', {
  variants: {
    variant: {

...
export function PixelControls({ pixelSize, onPixelSizeChange, colors, onColorsChange, pixelLabel, sizeOptions = DEFAULT_SIZE_OPTIONS, compact = false }: PixelControlsProps) {
  const { text } = useI18n()

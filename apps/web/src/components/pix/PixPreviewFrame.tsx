...
export function PixPreviewFrame({ url, alt, label, children, className, imageClassName }: { url?: string | null; alt?: string; label?: ReactNode; children?: ReactNode; className?: string; imageClassName?: string }) {
  return (

...
export function PixPreviewFrame({ url, alt, label, children, className, imageClassName, loading = false, trim = false }: { url?: string | null; alt?: string; label?: ReactNode; children?: ReactNode; className?: string; imageClassName?: string; loading?: boolean; trim?: boolean }) {
